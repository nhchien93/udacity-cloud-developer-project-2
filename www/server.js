...
(() => __awaiter(this, void 0, void 0, function* () {
    ...
    app.get("/filteredimage/", (req, res) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            let imagePath = yield util_1.filterImageFromURL(req.query.image_url);
            res.sendFile(imagePath, (err) => __awaiter(this, void 0, void 0, function* () {
                if (err) {
                    return res.status(201).send({ message: resourceNotFoundMess });
                }
                else {
                    yield util_1.deleteLocalFiles([imagePath]);
